...
@push('css')
    ...
    <link href="{{url('')}}/assets/frontend/single-post-1/css/styles.css" rel="stylesheet">

    <link href="{{url('')}}/assets/frontend/single-post-1/css/responsive.css" rel="stylesheet">
    <style>
        .header-bg{
            height: 400px;
            width: 100%;
                                        ...
                                        <li>
                                            ...
                                            @else
                                                <a href="javascript:void(0);" onclick="document.getElementById('favourite-form-{{$randompost->id}}').submit();"
                                                   class="{{!Auth::user()->favourite_posts->where('pivot.post_id',$randompost->id)->count() ==0 ? 'favourite_post' : ''}}">
                                                    <i class="ion-heart"></i>{{$post->favourite_to_users->count()}}
                                                </a>
                ...
                <div class="col-lg-8 col-md-12">
                    ...
                    @else
                        <div class="commnets-area ">
                            ...
                            <div class="comment">
                                <p>No comment yet. for the post </p>
                            </div>
