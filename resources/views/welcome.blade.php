...
@push('css')
    <link href="{{url('')}}/assets/frontend/front-page-category/css/styles.css" rel="stylesheet">
    <link href="{{url('')}}/assets/frontend/front-page-category/css/responsive.css" rel="stylesheet">
    <style>
        .favourite_post{
            color: blue;
        }
...
@endsection
@push('js')
    <script src="{{url('')}}/assets/frontend/common-js/swiper.js"></script>
@endpush